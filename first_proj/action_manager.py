...
class ActionManager():
    ...
    def stack(self, stacking_method: StackingMethod, box):
        print('stack')
        if stacking_method == StackingMethod.PALLET_X_EXCEED:
            return self.stack_pallet_x_exceed(box)
        elif stacking_method == StackingMethod.PALLET_Y_EXCEED:
            return self.stack_pallet_y_exceed(box)
        elif stacking_method == StackingMethod.PALLET_Z_EXCEED:
            return self.stack_pallet_z_exceed(box)
        elif stacking_method == StackingMethod.PALLET_CENTER:
            return self.stack_pallet_center(box)
        elif stacking_method == StackingMethod.PALLET_CENTER_ROT:
            return self.stack_pallet_center(box, box_max_rotation=90)
        elif stacking_method == StackingMethod.PALLET_CORNER_XY_AXIS:
            return self.stack_pallet_corner_xy_axis(box)
        elif stacking_method == StackingMethod.PALLET_CORNER_Z_AXIS:
            return self.stack_pallet_corner_z_axis(box)
    ...
    def stack_pallet_x_exceed(self, box):
        result = []
    ...
    def stack_pallet_y_exceed(self, box):
        result = []
    ...
    def stack_pallet_z_exceed(self, box):
        result = []
    ...
    def stack_pallet_center(self, box, box_max_rotation: int = 0):
        result = []
    ...
    def stack_pallet_corner_xy_axis(self, box):
        result = []
        corner_cnt = 4
        p_h = self.pallet_size[2]
    ...
    def stack_pallet_corner_z_axis(self, box):
        result = []
